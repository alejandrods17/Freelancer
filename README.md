# Descripción: Borrador-Freelancer
Este es un porfolio creado con el objetivo de mostrar un ejemplo o borrador de pagina web para un Frelancer, en donde se encontraran explicadas sus habilidades e informacion de contacto mediante un formulario.
